 ...
 */
class getASAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\ASAuthenticator' shared autowired service.
     *
     * @return \App\Security\ASAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'ASAuthenticator.php';

        return $container->privates['App\\Security\\ASAuthenticator'] = new \App\Security\ASAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
