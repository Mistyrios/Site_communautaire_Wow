...
/* tag/index.html.twig */
class __TwigTemplate_1f219e429155e649b9b3b72bc5d59269020448efdc5994d75c2e2a7112541da3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Wow Chronicles - Liste des tags";
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
            ...
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tag"], "couleur", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("tag_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["tag"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">Editer</a>
                </td>
            </tr>
        ";
...
{% block title %}Wow Chronicles - Liste des tags{% endblock %}
...
{% block body %}
    ...
    <a href=\"{{ path('tag_new') }}\">Crée un nouveau tag</a>
{% endblock %}
", "tag/index.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\tag\\index.html.twig");
    }
}
