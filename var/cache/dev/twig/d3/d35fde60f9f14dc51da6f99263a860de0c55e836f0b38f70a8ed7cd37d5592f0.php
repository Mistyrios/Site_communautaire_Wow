                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                        ...
                        echo "</div>
                            <div class=\"content\" style=\"display: flex; align-items: center; flex-direction: column\">
                                <img src=\"";
                        // line 18
                        echo twig_escape_filter($this->env, $this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(twig_get_attribute($this->env, $this->source, $context["article"], "image", [], "any", false, false, false, 18)), "article"), "html", null, true);
