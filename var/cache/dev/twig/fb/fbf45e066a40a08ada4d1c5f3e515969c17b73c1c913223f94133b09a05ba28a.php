...
/* user/show.html.twig */
class __TwigTemplate_5ed93ea38f0aa081dcd9da29bdf43b74005c0a3cf145da7e470ab33f3bd7ecc2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 6, $this->source); })()), "pseudo", [], "any", false, false, false, 6), "html", null, true);
        echo "</h1>

    <table class=\"table espaceCustom\">
        <tbody>
            <tr>
                <th>Pseudo</th>
                <td>";
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "isVerified", [], "any", false, false, false, 24)) ? ("Oui") : ("Non"));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  140 => 35,  134 => 32,  129 => 30,  120 => 24,  113 => 20,  106 => 16,  99 => 12,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Wow Chronicles - {{ app.user.pseudo }}{% endblock %}

{% block body %}
    <h1 class=\"espaceCustom\" >{{ user.pseudo }}</h1>
...
{% endblock %}
", "user/show.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\user\\show.html.twig");
    }
}
