...
class __TwigTemplate_f2aaee3ff499a68736e6708871ea5728545f76f2358fc8c4e1ec21419be30404 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        echo "
    <button class=\"btn\" style=\"background-color: #343A40; color: white; margin-bottom: 20px; margin-top: 20px\">";
        // line 5
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn\" style=\"background-color: #343A40; color: white; margin-bottom: 20px; margin-top: 20px\">{{ button_label|default('Enregistrer') }}</button>
{{ form_end(form) }}
", "article/_form.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\article\\_form.html.twig");
    }
}
