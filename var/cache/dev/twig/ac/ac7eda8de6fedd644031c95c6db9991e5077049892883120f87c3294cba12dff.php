...
class __TwigTemplate_b0fea8dc47b03610c78f6d7dfb87fdaeae12f83c51991a300e2e795eb295f403 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "article/_form.html.twig", ["button_label" => "Mettre à jour"]);
        echo "
...
{% block title %}Wow Chronicles - Editer {{ article.titre }}{% endblock %}

{% block body %}
    <h1 class=\"espaceCustom\">Editer {{ article.titre }}</h1>
...
{% endblock %}
", "article/edit.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\article\\edit.html.twig");
    }
}
