...
class __TwigTemplate_67e0e3263c54f6abbc7b5f2cced8f19d4a9a396102921c31ca86222d06afef29 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm(' Êtes vous sure de vouloir supprimer cet Article ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('article_delete', {'id': article.id}) }}\" onsubmit=\"return confirm(' Êtes vous sure de vouloir supprimer cet Article ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ article.id) }}\">
    <button class=\"btn\" style=\"background-color: #343A40; color: white; margin-bottom: 20px\">Supprimer</button>
</form>
", "article/_delete_form.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\article\\_delete_form.html.twig");
    }
}
