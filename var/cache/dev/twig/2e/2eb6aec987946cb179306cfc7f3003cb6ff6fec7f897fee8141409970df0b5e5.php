...
/* user/new.html.twig */
class __TwigTemplate_90f1779b8993a8db5034f7458737447dace06317d335607fac80eda1ffa5c030 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Wow Chronicles - Crée un nouvel utilisateur";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"espaceCustom\">Créer un nouvel utilisateur</h1>
...
{% block title %}Wow Chronicles - Crée un nouvel utilisateur{% endblock %}

{% block body %}
    <h1 class=\"espaceCustom\">Créer un nouvel utilisateur</h1>

    {{ include('user/_form.html.twig') }}

    <a href=\"{{ path('user_index') }}\">Retour à la liste</a>
{% endblock %}
", "user/new.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\user\\new.html.twig");
    }
}
