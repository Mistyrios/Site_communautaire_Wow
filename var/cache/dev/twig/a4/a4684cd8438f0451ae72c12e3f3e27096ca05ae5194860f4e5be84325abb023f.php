...
class __TwigTemplate_3d8ced9836c9e674384b7da0998dac7747332fb320836a6d891984d72b3d6bfd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Wow Chronicles - Liste des utilisateurs";
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "            <tr>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "pseudo", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            ...
            echo "</td>
                <td>";
            // line 24
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "isVerified", [], "any", false, false, false, 24)) ? ("Oui") : ("Non"));
            echo "</td>
                <td>
                    <a href=\"";
            // line 26
    ...
    <a href=\"";
        ...
        echo "\">Crée un nouvel utilisateur</a>
";
...
{% block title %}Wow Chronicles - Liste des utilisateurs{% endblock %}
...
{% block body %}
    ...
    <a href=\"{{ path('user_new') }}\">Crée un nouvel utilisateur</a>
{% endblock %}
", "user/index.html.twig", "D:\\Fichiers\\Documents\\IUT\\Cours\\Annee_2\\M3104\\TP\\SiteWow\\templates\\user\\index.html.twig");
    }
}
